  ...
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item menu-open">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="CatalogoLogos" class="nav-link active">
            <i class="far fa-circle nav-icon"></i>
      ...
      <div class="card-body">
          ...
          <table id="example2" class="table table-bordered table-hover">
           ...
           <th>Acciones</th>
              ...
              <tbody>
                  <tr>
                      <td>{{$catalogologo->id}}</td>
                 <td>
                            {{--  <img src="{{ asset('storage/uploads'.$catalogologo->logos )}}" alt="Logos" width="100px" height="100px" class="img-thumnail img-fluid"> --}}
                            <img src="{{ asset('storage/'.$catalogologo->logos )}}" alt="Logos" width="100px" height="100px" class="img-thumnail img-fluid">
                        </td> 

                      <td>
                        {{-- <form action="{{ url('/CatalogoLogos/'.$catalogologo->id) }}" method="POST">
                          @csrf
                          {{ method_field('DELETE') }}
                           ...
                           */
No eliminar imagen con id número 3 o cambiarlo en el archivo DocValesConsumibles para asignar el que
ustedes consideren 
*/
                        <form action="{{ url('/CatalogoLogos/'.$catalogologo->id) }}"
      method="POST"
    ...
    <button type="submit" class="btn btn-danger">Eliminar</button>
                        ...
                        <a type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-edit{{ $catalogologo->id }}">Editar</a>


                        <form action="{{ url('/CatalogoLogos/'.$catalogologo->id) }}" method="POST" enctype="multipart/form-data">

                          @csrf

                          {{ method_field('PATCH') }}
                          <div class="modal fade" id="modal-edit{{ $catalogologo->id }}"> 
                            <div class="modal-dialog modal-lg"> 
                            <div class="modal-content bg-light">
                              <div class="modal-header">
                                <h4 class="modal-title ml-auto">Registro de logos</h4>
                              ...
                              <div class="modal-body">
                               ...
                               @if(isset($catalogologo->logos))
                                  <img src="{{ asset('storage/'.$catalogologo->logos) }}" alt="Logos" width="100px" height="100px" class="img-thumnail img-fluid">      
                                  
                               @endif
                               <input type="file" id="logos" name="logos"  value="{{ old('logos', $catalogologo->logos ??' ')}}" class="form-control"></input>
          ...
          <form action="{{ url('/CatalogoLogos') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="modal-content bg-light">
                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <input type="file" id="logos" name="logos" value="{{ old('logos'   )}}" class="form-control"></input>
