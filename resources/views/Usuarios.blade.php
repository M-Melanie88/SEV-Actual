...
<form action="{{ url('/Usuarios/'.$usuario->id) }}"
    ...
    <button type="submit" class="btn btn-danger">Eliminar</button>
                        ...
                        <a type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-edit{{ $usuario->id }}">Editar</a>
                        ...
                        <form action="{{ url('/Usuarios/'.$usuario->id) }}" method="POST">
                          ...
                          {{ method_field('PATCH') }}
                          <div class="modal fade" id="modal-edit{{ $usuario->id }}"> 
                            <div class="modal-dialog modal-lg"> 
                            <div class="modal-content bg-light">
                              <div class="modal-header">
                                <h4 class="modal-title ml-auto">Edición de usuarios</h4>
                              ...
                              <div class="modal-body">
                                ...
                                <input type="text" id="nombre" name="nombre" placeholder="Escribir nombre" value="{{ old('nombre', $usuario->nombre ??' ')}}" class="form-control"></input>
                                ...
                                {{-- <select name="id_equipo_prestado" id="id_equipo_prestado"> --}}
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" id="apellido_paterno" name="apellido_paterno" value="{{ old('apellido_paterno', $usuario->apellido_paterno) }}" class="form-control"> 
                                  ...
                                  <input type="text" id="apellido_materno" name="apellido_materno"  value="{{ old('apellido_materno', $usuario->apellido_materno ??' ')}}" class="form-control"></input>
                                  ...
                                  <input type="text" id="nombre_usuario" name="nombre_usuario" placeholder="Escribir el nombre de usuario"   value="{{ old('nombre_usuario', $usuario->nombre_usuario ??' ')}}" class="form-control"></input>
                                  ...
                                  <input type="text" id="password" name="password" placeholder="Escribir el password"   value="{{ old('password', $usuario->password ??' ')}}" class="form-control"></input>
                                  ...
                                  {{-- <input type="text" id="rol" name="rol" placeholder="Escribir el rol"   value="{{ old('rol', $usuario->rol ??' ')}}" class="form-control"></input> --}}
                              <select name="rol" id="rol" class="form-control">
                                <option value="1">1. Administrador</option>
                                <option value="2">2. Capturista</option>
                                <option value="3">3. Lector</option>
                              </select>
                                    </div>
                                  </div>
          ...
          <form action="{{ url('/Usuarios') }}" method="POST">
            ...
            <div class="modal fade" id="modal-create"> 
              ...
              <div class="modal-content bg-light">
                <div class="modal-header">
                  <h4 class="modal-title ml-auto">Registro de usuarios</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <div class="row">
                    ...
                    {{-- <select name="id_equipo_prestado" id="id_equipo_prestado"> --}}
                      ...
                      <input type="text" id="nombre_usuario" name="nombre_usuario"  placeholder="Escribir el nombre de usuario"  value="{{ old('nombre_usuario')}}" class="form-control"></input>
                      ...
                      <input type="password" id="password" name="password"  placeholder="Escribir el password"  value="{{ old('password')}}" class="form-control"></input>
                      ...
                      {{-- <input type="text" id="rol" name="rol"  placeholder="Escribir el rol"  value="{{ old('rol')}}" class="form-control"></input> --}}
                      <select name="rol" id="rol" class="form-control">
                        <option value="1">1. Administrador</option>
                        <option value="2">2. Capturista</option>
                        <option value="3">3.Lector</option>
