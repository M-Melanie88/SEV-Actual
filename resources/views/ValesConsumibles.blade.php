  ...
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item menu-open">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="ValesConsumibles" class="nav-link active">
            <i class="far fa-circle nav-icon"></i>
...
@endforeach
              ...
              @foreach($valesconsumibles as $valeconsumible)
              <tbody>
                  <tr>
                      <td>{{$valeconsumible->id}}</td>
                      <td>{{$valeconsumible->cat_nombre->nombre ?? ' '}}</td> 
                      <td>{{$valeconsumible->tipoconsumible->tipo_consumible ?? ' '}}</td>
                      <td>{{$valeconsumible->fecha_emision ?? ' '}}</td>
                      <td>{{$valeconsumible->observaciones ?? ' '}}</td>
...
<form action="{{ url('/ValesConsumibles/'.$valeconsumible->id) }}"
    ...
    <button type="submit" class="btn btn-danger">Eliminar</button>
                        ...
                        <form action="{{ url('/ValesConsumibles/'.$valeconsumible->id) }}" method="POST">
                          ...
                          {{ method_field('PATCH') }}
                          <div class="modal fade" id="modal-edit{{ $valeconsumible->id }}"> 
                            <div class="modal-dialog modal-lg"> 
                            <div class="modal-content bg-light">
                              <div class="modal-header">
                                <h4 class="modal-title ml-auto">Edición de vales</h4>
                                ...
                                {{-- <select name="id_equipo_prestado" id="id_equipo_prestado"> --}}
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <label for="id_tipo_consumible">Consumible</label>
                                      <select name="id_tipo_consumible" id="id_tipo_consumible" class="form-control"> 
                                        @foreach($tiposconsumibles as $tipoconsumible)
                                            <option value="{{ $tipoconsumible->id }}" >{{ $tipoconsumible->tipo_consumible}}</option>
                                            @endforeach 
                                ...
                                {{-- <select name="id_equipo_prestado" id="id_equipo_prestado"> --}}
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="date" id="fecha_emision" name="fecha_emision" value="{{ old('fecha_emision', $valeconsumible->fecha_emision) }}" class="form-control"> 
                                  ...
                                  {{-- <input type="text" id="cantidad" name="cantidad"  value="{{ old('cantidad', $valeconsumible->cantidad ??' ')}}" class="form-control"></input> --}}
                              <select name="cantidad" id="cantidad" class="form-control">
                                ...
                                <option value="10">10</option>
                                  ...
                                  <input type="text" id="observaciones" name="observaciones"  value="{{ old('observaciones', $valeconsumible->observaciones ??' ')}}" class="form-control"></input>
...
{{-- No mover esta linea de codigo o afectara el filtrado de datos  --}}
          ...
          <form action="{{ url('/ValesConsumibles') }}" method="POST">
            ...
            <div class="modal fade" id="modal-create"> 
              ...
              <div class="modal-content bg-light">
                <div class="modal-header">
                  <h4 class="modal-title ml-auto">Registro de vales</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  {{-- <select name="id_equipo_prestado" id="id_equipo_prestado"> --}}
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="date" id="fecha_emision" name="fecha_emision" value="{{ old('fecha_emision') }}" class="form-control"> 
                ...
                <select name="cantidad" id="cantidad" class="form-control">
                  ...
                  <option value="10">10</option>
                    ...
                    <input type="text" id="observaciones" name="observaciones"  placeholder="Escribe una Descripción" value="{{ old('observaciones')}}" class="form-control"></input>
